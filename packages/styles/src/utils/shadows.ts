...
export function createGlows( baseRgb: number[] ) {
	return [
		'none',
		createGlow( baseRgb, 0, 1, 2, 0 ),
		createGlow( baseRgb, 0, 1, 4, 0 ),
		createGlow( baseRgb, 0, 1, 5, 1 ),
		createGlow( baseRgb, 0, 2, 7, 1 ),
		createGlow( baseRgb, 0, 2, 8, 2 ),
		createGlow( baseRgb, 0, 2, 10, 2 ),
		createGlow( baseRgb, 0, 3, 10, 3 ),
		createGlow( baseRgb, 0, 3, 10, 3 ),
		createGlow( baseRgb, 0, 3, 12, 4 ),
		createGlow( baseRgb, 0, 4, 14, 4 ),
		createGlow( baseRgb, 0, 4, 15, 4 ),
		createGlow( baseRgb, 0, 4, 17, 5 ),
		createGlow( baseRgb, 0, 5, 19, 5 ),
		createGlow( baseRgb, 0, 5, 21, 5 ),
		createGlow( baseRgb, 0, 5, 22, 6 ),
		createGlow( baseRgb, 0, 6, 24, 6 ),
		createGlow( baseRgb, 0, 6, 26, 6 ),
		createGlow( baseRgb, 0, 6, 28, 7 ),
		createGlow( baseRgb, 0, 6, 29, 7 ),
		createGlow( baseRgb, 0, 6, 31, 7 ),
		createGlow( baseRgb, 0, 7, 33, 8 ),
		createGlow( baseRgb, 0, 7, 35, 8 ),
		createGlow( baseRgb, 0, 7, 36, 8 ),
		createGlow( baseRgb, 0, 7, 38, 8 ),
	];
}